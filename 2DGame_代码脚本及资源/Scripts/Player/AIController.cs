...
public class AIController : Controller
{
    ...
    void Update()
    {
        ...
        {
            SaveManager.instance.activeSave.newposition=transform.position;
            Debug.Log(SaveManager.instance.activeSave.newposition);
            SaveManager.instance.Saved=false;
        }
        if(SaveManager.instance.Loaded)
        {
            transform.position=SaveManager.instance.activeSave.newposition;
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            SaveManager.instance.sparkobj[SaveManager.instance.activeSave.i]=collision.gameObject;
            SaveManager.instance.activeSave.booll[SaveManager.instance.activeSave.i]= true;
            SaveManager.instance.sparkobj[SaveManager.instance.activeSave.i].SetActive(false); 
            //collision.transform.gameObject.SetActive(false); 
            SaveManager.instance.activeSave.i++;         
            //Destroy(collision.transform.gameObject);
            //spark++;
